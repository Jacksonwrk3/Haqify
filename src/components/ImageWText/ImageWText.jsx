...
function ImageWText(props) {
  ...
  if (props.imgPosition === "left") {
    imgPosition = "md:flex-row-reverse md:pr-6";
  } else {
    imgPosition = "md:flex-row md:pl-6";
  }
  ...
  return (
    <section className="pt-10 bg-gray-50 md:flex md:justify-center md:items-center">
      ...
      >
        <div className="flex flex-col justify-center px-2 space-y-4 md:justify-center md:w-1/2">
